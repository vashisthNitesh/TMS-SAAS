...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'django-insecure-tame-super-secure-dev-key')
...
ROOT_URLCONF = 'tame_backend.urls'
...
WSGI_APPLICATION = 'tame_backend.wsgi.application'
